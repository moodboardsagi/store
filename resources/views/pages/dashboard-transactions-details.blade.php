                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-md-4">
                                    <img src="{{ Storage::url($transaction->product->galleries->first()->photos ?? '') }}" class="w-75 mb-3">
                                </div>
                            ...
                            <form action="{{ route('dashboard-transaction-update', $transaction->id) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-3">
                                                ...
                                                <select class="form-select form-control" id="status" name="shipping_status" v-model="status" aria-label="Default select example">
                                            ...
                                            <template v-if="status == 'SHIPPING'">
                                                ...
                                                <div class="col-md-2">
                                                    <button type="submit" class="btn btn-success d-grid" style="margin-top: 35px;">Update Resi</button>
                                                </div>
                                            </template>
                                        </div>
                                    </div>
                                ...
                                <div class="row mt-4">
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-success d-grid mt-4 float-end btn-lg">Save Now</button>
                                    </div>
                                </div>
                            </form>
                        </div>
